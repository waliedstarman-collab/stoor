...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'متجرنا'); ?></title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('website.home')); ?>">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('website.home')); ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="categoriesDropdown">
                            ...
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('website.category', $cat->slug)); ?>">
                                    <?php echo e($cat->name); ?>

                                    <span class="category-badge"><?php echo e($cat->products_count); ?></span>
                                </a>
                            </li>
...
</html><?php /**PATH C:\Users\pc\Herd\store\resources\views/website/layout.blade.php ENDPATH**/ ?>